            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" id="L_id" name="id" required="" lay-verify="id"
                           autocomplete="off" class="layui-input" readonly value="${editUser.id}">
                </div>
            </div>
            <div class="layui-form-item">
                <label for="L_name" class="layui-form-label">
                ...
                <div class="layui-input-inline">
                    <input type="text" id="L_name" name="name" required="" lay-verify="name"
                           autocomplete="off" class="layui-input" value="${editUser.name}"></div>
            </div>
            <div class="layui-form-item">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <select id="gender" name="gender" class="valid">
                        ...
                        <option value="女" ${editUser.gender== "女" ? "selected" : ""} >女</option>
                    </select>
                </div>
            </div>
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" id="L_telephone" name="telephone" required="" lay-verify="telephone"
                           autocomplete="off" class="layui-input" value="${editUser.telephone}"></div>
            </div>
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" id="L_email" name="email" required="" lay-verify="email"
                           autocomplete="off" class="layui-input" value="${editUser.email}"></div>
            </div>
            <div class="layui-form-item">
        ...
        function () {
            ...
            form.verify({
                oldpass: function (value) {
                    if ($('#L_oldpass').val() != "${editUser.password}") {
                        return '密码错误，无法修改';
                    }
                },
                ...
                function (data) {
                    ...
                    $.ajax({
                        ...
                        success: function (res) {
                            ...
                            if (res.state == 1) {
                                //弹出提示，并在1秒后关闭当前页面
                                layer.msg("修改成功", {icon: 1, time: 0100}, function () {
                                    //关闭当前页面
