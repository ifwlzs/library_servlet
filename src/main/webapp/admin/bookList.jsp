        ...
        <div class="layui-col-md12">
            <div class="layui-card">
                <div class="layui-card-header">
                    <button class="layui-btn" onclick="xadmin.open('添加书籍','/admin/toAddBookServlet')"><i
                            class="layui-icon"></i>添加书籍
                    </button>
                </div>
                        ...
                        <c:forEach items="${bookList}" var="book" varStatus="status">
                            ...
                            <tr>
                                ...
                                <td class="td-manage" style="text-align: center">
                                    <a title="编辑"
                                       onclick="xadmin.open('编辑','/admin/toEditBookServlet?id=${book.bookID}')"
                                       href="javascript:;">
                                    ...
                                    <br>
                                    <a title="查询借阅记录"
                                       onclick="xadmin.open('查询借阅记录','/admin/toBorrowListServlet?bookID=${book.bookID}')"
                                       href="javascript:;">
                                        <i class="layui-icon">&#xe60a;</i>
                                    </a>
                                    <a title="查询未归还记录"
                                       onclick="xadmin.open('查询未归还记录','/admin/toBorrowListServlet?bookID=${book.bookID}&isNull=T')"
                                       href="javascript:;">
                                        <i class="layui-icon">&#xe615;</i>
                                    </a>
                                </td>
